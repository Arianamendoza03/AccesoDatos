...
namespace AccesoDatos
{
    public partial class AccederDatos : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
                ...
                //1. crear la conexion
                SqlConnection conexion = new SqlConnection(@"server=L-ELR-010\SQLEXPRESS; database=TI2021; Integrated Security=true");
            ...
            {
                MessageBox.Show("Se tiene que llenar todos  los datos ");
            }
            catch (Exception E)
            {
